    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <nav className="flex-1 p-3 sm:p-4 space-y-1 sm:space-y-2 overflow-y-auto">
          ...
          <NavLink to="stagiairesmd" className={({ isActive }) => `block py-2 px-3 sm:px-4 rounded text-sm sm:text-base transition-all ${isActive ? "bg-blue-100 text-dégradé shadow-md" : "hover:bg-blue-200 hover:text-blue-700"}`}>
            <div className="flex items-center">
          ...
          <NavLink to="evaluations" className={({ isActive }) => `block py-2 px-3 sm:px-4 rounded text-sm sm:text-base transition-all ${isActive ? "bg-blue-100 text-dégradé shadow-md" : "hover:bg-blue-200 hover:text-blue-700"}`}>
            <div className="flex items-center">
