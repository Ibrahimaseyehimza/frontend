...
// // Simuler useAuth pour la démo
// const useAuth = () => ({ user: { name: "Chef Métier", metier_id: 1 } });
...
//           {
//             id: 1,
//             etudiant: { prenom: "Ibrahima", nom: "seye", telephone: "+221771234567", email: "ibrahima@example.com" },
//             entreprise: { id: 1, nom: "Defar Sci" }
//           },
//           {
//             id: 2,
//             etudiant: { prenom: "Yannick", nom: "Barella", telephone: "+221772345678", email: "yannick@example.com" },
//             entreprise: { id: 1, nom: "Defar Sci" }
//           },
//           {
//             id: 3,
//             etudiant: { prenom: "Ahmed", nom: "Fall", telephone: "+221773456789", email: "ahmed@example.com" },
//             entreprise: { id: 2, nom: "Orange" }
//           }
//         ],
//         metier: { id: 1, nom: "Développement Web" }
//       }
//     };
//   },
//   post: async (url) => {
...
//   const handleDownload = async (type) => {
//     alert(`📥 Téléchargement ${type.toUpperCase()} simulé`);
//   };
